...
public class GetFriendforumServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			JSONArray jsonArray=JsonUtil.formatRsToJsonArray(forumDao.getfriendforum(con));
			result.put("forumrows", jsonArray);
