...
public class UpLoadServlet extends HttpServlet {
    ...
    // 上传文件存储目录
    private static final String UPLOAD_DIRECTORY = "D:\\java EE\\eclipse\\workspace\\teenagersbasketball\\WebContent\\head portrait";
        ...
        try {
            ...
            if (formItems != null && formItems.size() > 0) {
                ...
                for (FileItem item : formItems) {
                    // 处理不在表单中的字段
                    if (!item.isFormField()) {
                        String fileName = (currentUser.getId()+"-head portrait.jpg");
                        ...
                        if(currentUser.getIdentity()==1){
                        	...
                        	response.sendRedirect("web/pages/coamain.jsp");
