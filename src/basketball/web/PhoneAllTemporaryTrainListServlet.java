...
public class PhoneAllTemporaryTrainListServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			int total=trainDao.alltemporarytrainCount(con,currentUser.getId());
			JSONArray jsonArray=JsonUtil.formatRsToJsonArray(trainDao.alltemporarytrainList(con,currentUser.getId(),pageBean));
