...
public class PhoneGetTemporaryStudentServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			JSONArray jsonArray=JsonUtil.formatRsToJsonArray(coachDao.phonegettemporarystudent(con,currentUser.getId()));
