...
public class PhoneCoaStuListServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			int total=coachDao.phonecoastuCount(con,currentUser.getId());
			JSONArray jsonArray=JsonUtil.formatRsToJsonArray(coachDao.phonecoastuList(con,currentUser.getId(),pageBean));
