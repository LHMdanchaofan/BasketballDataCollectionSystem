...
public class FeedBackServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			int total=trainDao.feedBackCount(con,currentUser.getId());
			JSONArray jsonArray=JsonUtil.formatRsToJsonArray(trainDao.feedBack(con,currentUser.getId(),pageBean));
